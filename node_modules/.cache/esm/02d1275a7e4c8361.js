let jwt,findUserByEmail,validateFields,bcrypt;_7e4‍.x([["loginUser",()=>loginUser]]);_7e4‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_7e4‍.w("../services/User",[["findUserByEmail",["findUserByEmail"],function(v){findUserByEmail=v}]]);_7e4‍.w("./validateFields",[["default",["validateFields"],function(v){validateFields=v}]]);_7e4‍.w("bcrypt",[["default",["bcrypt"],function(v){bcrypt=v}]]);
  ...
  try {
    ...
    _7e4‍.g.console.log(error.message)
